...
goog.functions.not=function(a){return function(){return!a.apply(this,arguments)}};goog.functions.create=function(a,b){var c=function(){};c.prototype=a.prototype;c=new c;a.apply(c,Array.prototype.slice.call(arguments,1));return c};goog.functions.CACHE_RETURN_VALUE=!0;goog.functions.cacheReturnValue=function(a){var b=!1,c;return function(){if(!goog.functions.CACHE_RETURN_VALUE)return a();b||(c=a(),b=!0);return c}};goog.array={};goog.NATIVE_ARRAY_PROTOTYPES=goog.TRUSTED_SITE;goog.array.peek=function(a){return a[a.length-1]};goog.array.ARRAY_PROTOTYPE_=Array.prototype;
...
goog.Uri.QueryData.prototype.extend=function(a){for(var b=0;b<arguments.length;b++)goog.structs.forEach(arguments[b],function(a,b){this.add(b,a)},this)};goog.json={};goog.json.isValid_=function(a){return/^\s*$/.test(a)?!1:/^[\],:{}\s\u2028\u2029]*$/.test(a.replace(/\\["\\\/bfnrtu]/g,"@").replace(/"[^"\\\n\r\u2028\u2029\x00-\x08\x0a-\x1f]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,"]").replace(/(?:^|:|,)(?:[\s\u2028\u2029]*\[)+/g,""))};goog.json.parse=function(a){a=String(a);if(goog.json.isValid_(a))try{return eval("("+a+")")}catch(b){}throw Error("Invalid JSON string: "+a);};goog.json.unsafeParse=function(a){return eval("("+a+")")};
...
goog.log.log=function(a,b,c,d){goog.log.ENABLED&&a&&a.log(b,c,d)};goog.log.error=function(a,b,c){goog.log.ENABLED&&a&&a.severe(b,c)};goog.log.warning=function(a,b,c){goog.log.ENABLED&&a&&a.warning(b,c)};goog.log.info=function(a,b,c){goog.log.ENABLED&&a&&a.info(b,c)};goog.log.fine=function(a,b,c){goog.log.ENABLED&&a&&a.fine(b,c)};goog.net={};goog.net.ChannelDebug=function(){this.logger_=goog.log.getLogger("goog.net.BrowserChannel")};goog.net.ChannelDebug.prototype.getLogger=function(){return this.logger_};goog.net.ChannelDebug.prototype.browserOfflineResponse=function(a){this.info("BROWSER_OFFLINE: "+a)};goog.net.ChannelDebug.prototype.xmlHttpChannelRequest=function(a,b,c,d,e){this.info("XMLHTTP REQ ("+c+") [attempt "+d+"]: "+a+"\n"+b+"\n"+this.maybeRedactPostData_(e))};
goog.net.ChannelDebug.prototype.xmlHttpChannelResponseMetaData=function(a,b,c,d,e,f){this.info("XMLHTTP RESP ("+c+") [ attempt "+d+"]: "+a+"\n"+b+"\n"+e+" "+f)};goog.net.ChannelDebug.prototype.xmlHttpChannelResponseText=function(a,b,c){this.info("XMLHTTP TEXT ("+a+"): "+this.redactResponse_(b)+(c?" "+c:""))};goog.net.ChannelDebug.prototype.tridentChannelRequest=function(a,b,c,d){this.info("TRIDENT REQ ("+c+") [ attempt "+d+"]: "+a+"\n"+b)};
goog.net.ChannelDebug.prototype.tridentChannelResponseText=function(a,b){this.info("TRIDENT TEXT ("+a+"): "+this.redactResponse_(b))};goog.net.ChannelDebug.prototype.tridentChannelResponseDone=function(a,b){this.info("TRIDENT TEXT ("+a+"): "+b?"success":"failure")};goog.net.ChannelDebug.prototype.timeoutResponse=function(a){this.info("TIMEOUT: "+a)};goog.net.ChannelDebug.prototype.debug=function(a){this.info(a)};
goog.net.ChannelDebug.prototype.dumpException=function(a,b){this.severe((b||"Exception")+a)};goog.net.ChannelDebug.prototype.info=function(a){goog.log.info(this.logger_,a)};goog.net.ChannelDebug.prototype.warning=function(a){goog.log.warning(this.logger_,a)};goog.net.ChannelDebug.prototype.severe=function(a){goog.log.error(this.logger_,a)};
goog.net.ChannelDebug.prototype.redactResponse_=function(a){if(!a||a==goog.net.BrowserChannel.MAGIC_RESPONSE_COOKIE)return a;try{var b=goog.json.unsafeParse(a);if(b)for(var c=0;c<b.length;c++)goog.isArray(b[c])&&this.maybeRedactArray_(b[c]);return goog.json.serialize(b)}catch(d){return this.debug("Exception parsing expected JS array - probably was not JS"),a}};
goog.net.ChannelDebug.prototype.maybeRedactArray_=function(a){if(!(2>a.length||(a=a[1],!goog.isArray(a)||1>a.length))){var b=a[0];if("noop"!=b&&"stop"!=b)for(b=1;b<a.length;b++)a[b]=""}};goog.net.ChannelDebug.prototype.maybeRedactPostData_=function(a){if(!a)return null;var b="";a=a.split("&");for(var c=0;c<a.length;c++){var d=a[c].split("=");if(1<d.length)var e=d[0],d=d[1],f=e.split("_"),b=2<=f.length&&"type"==f[1]?b+(e+"="+d+"&"):b+(e+"=redacted&")}return b};goog.string.Stringifier=function(){};goog.string.Parser=function(){};goog.json.Processor=function(){};goog.json.EvalJsonProcessor=function(a,b){this.serializer_=new goog.json.Serializer(a);this.parser_=b?goog.json.unsafeParse:goog.json.parse};goog.json.EvalJsonProcessor.prototype.stringify=function(a){return this.serializer_.serialize(a)};goog.json.EvalJsonProcessor.prototype.parse=function(a){return this.parser_(a)};goog.disposable={};goog.disposable.IDisposable=function(){};goog.Disposable=function(){goog.Disposable.MONITORING_MODE!=goog.Disposable.MonitoringMode.OFF&&(goog.Disposable.INCLUDE_STACK_ON_CREATION&&(this.creationStack=Error().stack),goog.Disposable.instances_[goog.getUid(this)]=this)};goog.Disposable.MonitoringMode={OFF:0,PERMANENT:1,INTERACTIVE:2};goog.Disposable.MONITORING_MODE=0;goog.Disposable.INCLUDE_STACK_ON_CREATION=!0;goog.Disposable.instances_={};
...
this.appendNewline&&b.push("\n");return b.join("")};goog.events.EventHandler=function(a){goog.Disposable.call(this);this.handler_=a;this.keys_={}};goog.inherits(goog.events.EventHandler,goog.Disposable);goog.events.EventHandler.typeArray_=[];goog.events.EventHandler.prototype.listen=function(a,b,c,d,e){goog.isArray(b)||(goog.events.EventHandler.typeArray_[0]=b,b=goog.events.EventHandler.typeArray_);for(var f=0;f<b.length;f++){var g=goog.events.listen(a,b[f],c||this.handleEvent,d||!1,e||this.handler_||this);if(!g)break;this.keys_[g.key]=g}return this};
...
goog.async.Throttle.prototype.onTimer_=function(){this.timer_=null;this.shouldFire_&&!this.pauseCount_&&(this.shouldFire_=!1,this.doAction_())};goog.async.Throttle.prototype.doAction_=function(){this.timer_=goog.Timer.callOnce(this.callback_,this.interval_);this.listener_.call(this.handler_)};goog.net.ChannelRequest=function(a,b,c,d,e){this.channel_=a;this.channelDebug_=b;this.sid_=c;this.rid_=d;this.retryId_=e||1;this.timeout_=goog.net.ChannelRequest.TIMEOUT_MS;this.eventHandler_=new goog.events.EventHandler(this);this.pollingTimer_=new goog.Timer;this.pollingTimer_.setInterval(goog.net.ChannelRequest.POLLING_INTERVAL_MS)};goog.net.ChannelRequest.prototype.extraHeaders_=null;goog.net.ChannelRequest.prototype.successful_=!1;goog.net.ChannelRequest.prototype.watchDogTimerId_=null;
goog.net.ChannelRequest.prototype.watchDogTimeoutTime_=null;goog.net.ChannelRequest.prototype.requestStartTime_=null;goog.net.ChannelRequest.prototype.type_=null;goog.net.ChannelRequest.prototype.baseUri_=null;goog.net.ChannelRequest.prototype.requestUri_=null;goog.net.ChannelRequest.prototype.postData_=null;goog.net.ChannelRequest.prototype.xmlHttp_=null;goog.net.ChannelRequest.prototype.xmlHttpChunkStart_=0;goog.net.ChannelRequest.prototype.trident_=null;
goog.net.ChannelRequest.prototype.verb_=null;goog.net.ChannelRequest.prototype.lastError_=null;goog.net.ChannelRequest.prototype.lastStatusCode_=-1;goog.net.ChannelRequest.prototype.sendClose_=!0;goog.net.ChannelRequest.prototype.cancelled_=!1;goog.net.ChannelRequest.prototype.readyStateChangeThrottleMs_=0;goog.net.ChannelRequest.prototype.readyStateChangeThrottle_=null;goog.net.ChannelRequest.TIMEOUT_MS=45E3;goog.net.ChannelRequest.POLLING_INTERVAL_MS=250;
goog.net.ChannelRequest.MIN_WEBKIT_FOR_INTERACTIVE_="420+";goog.net.ChannelRequest.Type_={XML_HTTP:1,IMG:2,TRIDENT:3};goog.net.ChannelRequest.Error={STATUS:0,NO_DATA:1,TIMEOUT:2,UNKNOWN_SESSION_ID:3,BAD_DATA:4,HANDLER_EXCEPTION:5,BROWSER_OFFLINE:6,ACTIVE_X_BLOCKED:7};
goog.net.ChannelRequest.errorStringFromCode=function(a,b){switch(a){case goog.net.ChannelRequest.Error.STATUS:return"Non-200 return code ("+b+")";case goog.net.ChannelRequest.Error.NO_DATA:return"XMLHTTP failure (no data)";case goog.net.ChannelRequest.Error.TIMEOUT:return"HttpConnection timeout";default:return"Unknown error"}};goog.net.ChannelRequest.INVALID_CHUNK_={};goog.net.ChannelRequest.INCOMPLETE_CHUNK_={};goog.net.ChannelRequest.supportsXhrStreaming=function(){return!goog.userAgent.IE||goog.userAgent.isDocumentModeOrHigher(10)};
goog.net.ChannelRequest.prototype.setExtraHeaders=function(a){this.extraHeaders_=a};goog.net.ChannelRequest.prototype.setTimeout=function(a){this.timeout_=a};goog.net.ChannelRequest.prototype.setReadyStateChangeThrottle=function(a){this.readyStateChangeThrottleMs_=a};goog.net.ChannelRequest.prototype.xmlHttpPost=function(a,b,c){this.type_=goog.net.ChannelRequest.Type_.XML_HTTP;this.baseUri_=a.clone().makeUnique();this.postData_=b;this.decodeChunks_=c;this.sendXmlHttp_(null)};
goog.net.ChannelRequest.prototype.xmlHttpGet=function(a,b,c,d){this.type_=goog.net.ChannelRequest.Type_.XML_HTTP;this.baseUri_=a.clone().makeUnique();this.postData_=null;this.decodeChunks_=b;d&&(this.sendClose_=!1);this.sendXmlHttp_(c)};
goog.net.ChannelRequest.prototype.sendXmlHttp_=function(a){this.requestStartTime_=goog.now();this.ensureWatchDogTimer_();this.requestUri_=this.baseUri_.clone();this.requestUri_.setParameterValues("t",this.retryId_);this.xmlHttpChunkStart_=0;var b=this.channel_.shouldUseSecondaryDomains();this.xmlHttp_=this.channel_.createXhrIo(b?a:null);0<this.readyStateChangeThrottleMs_&&(this.readyStateChangeThrottle_=new goog.async.Throttle(goog.bind(this.xmlHttpHandler_,this,this.xmlHttp_),this.readyStateChangeThrottleMs_));
this.eventHandler_.listen(this.xmlHttp_,goog.net.EventType.READY_STATE_CHANGE,this.readyStateChangeHandler_);a=this.extraHeaders_?goog.object.clone(this.extraHeaders_):{};this.postData_?(this.verb_="POST",a["Content-Type"]="application/x-www-form-urlencoded",this.xmlHttp_.send(this.requestUri_,this.verb_,this.postData_,a)):(this.verb_="GET",this.sendClose_&&!goog.userAgent.WEBKIT&&(a.Connection="close"),this.xmlHttp_.send(this.requestUri_,this.verb_,null,a));this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_MADE);
this.channelDebug_.xmlHttpChannelRequest(this.verb_,this.requestUri_,this.rid_,this.retryId_,this.postData_)};goog.net.ChannelRequest.prototype.readyStateChangeHandler_=function(a){a=a.target;var b=this.readyStateChangeThrottle_;b&&a.getReadyState()==goog.net.XmlHttp.ReadyState.INTERACTIVE?(this.channelDebug_.debug("Throttling readystatechange."),b.fire()):this.xmlHttpHandler_(a)};
goog.net.ChannelRequest.prototype.xmlHttpHandler_=function(a){goog.net.BrowserChannel.onStartExecution();try{if(a==this.xmlHttp_)this.onXmlHttpReadyStateChanged_();else this.channelDebug_.warning("Called back with an unexpected xmlhttp")}catch(b){this.channelDebug_.debug("Failed call to OnXmlHttpReadyStateChanged_"),this.xmlHttp_&&this.xmlHttp_.getResponseText()?this.channelDebug_.dumpException(b,"ResponseText: "+this.xmlHttp_.getResponseText()):this.channelDebug_.dumpException(b,"No response text")}finally{goog.net.BrowserChannel.onEndExecution()}};
goog.net.ChannelRequest.prototype.onXmlHttpReadyStateChanged_=function(){var a=this.xmlHttp_.getReadyState(),b=this.xmlHttp_.getLastErrorCode(),c=this.xmlHttp_.getStatus();if(!goog.net.ChannelRequest.supportsXhrStreaming()||goog.userAgent.WEBKIT&&!goog.userAgent.isVersionOrHigher(goog.net.ChannelRequest.MIN_WEBKIT_FOR_INTERACTIVE_)){if(a<goog.net.XmlHttp.ReadyState.COMPLETE)return}else if(a<goog.net.XmlHttp.ReadyState.INTERACTIVE||a==goog.net.XmlHttp.ReadyState.INTERACTIVE&&!goog.userAgent.OPERA&&
!this.xmlHttp_.getResponseText())return;this.cancelled_||a!=goog.net.XmlHttp.ReadyState.COMPLETE||b==goog.net.ErrorCode.ABORT||(b==goog.net.ErrorCode.TIMEOUT||0>=c?this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_FAILED):this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_SUCCEEDED));this.cancelWatchDogTimer_();this.lastStatusCode_=b=this.xmlHttp_.getStatus();(c=this.xmlHttp_.getResponseText())||this.channelDebug_.debug("No response text for uri "+
this.requestUri_+" status "+b);this.successful_=200==b;this.channelDebug_.xmlHttpChannelResponseMetaData(this.verb_,this.requestUri_,this.rid_,this.retryId_,a,b);if(this.successful_){if(a==goog.net.XmlHttp.ReadyState.COMPLETE&&this.cleanup_(),this.decodeChunks_?(this.decodeNextChunks_(a,c),goog.userAgent.OPERA&&this.successful_&&a==goog.net.XmlHttp.ReadyState.INTERACTIVE&&this.startPolling_()):(this.channelDebug_.xmlHttpChannelResponseText(this.rid_,c,null),this.safeOnRequestData_(c)),this.successful_&&
!this.cancelled_)if(a==goog.net.XmlHttp.ReadyState.COMPLETE)this.channel_.onRequestComplete(this);else this.successful_=!1,this.ensureWatchDogTimer_()}else 400==b&&0<c.indexOf("Unknown SID")?(this.lastError_=goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID,goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_UNKNOWN_SESSION_ID),this.channelDebug_.warning("XMLHTTP Unknown SID ("+this.rid_+")")):(this.lastError_=goog.net.ChannelRequest.Error.STATUS,goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_BAD_STATUS),
this.channelDebug_.warning("XMLHTTP Bad status "+b+" ("+this.rid_+")")),this.cleanup_(),this.dispatchFailure_()};
goog.net.ChannelRequest.prototype.decodeNextChunks_=function(a,b){for(var c=!0;!this.cancelled_&&this.xmlHttpChunkStart_<b.length;){var d=this.getNextChunk_(b);if(d==goog.net.ChannelRequest.INCOMPLETE_CHUNK_){a==goog.net.XmlHttp.ReadyState.COMPLETE&&(this.lastError_=goog.net.ChannelRequest.Error.BAD_DATA,goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_INCOMPLETE_DATA),c=!1);this.channelDebug_.xmlHttpChannelResponseText(this.rid_,null,"[Incomplete Response]");break}else if(d==
goog.net.ChannelRequest.INVALID_CHUNK_){this.lastError_=goog.net.ChannelRequest.Error.BAD_DATA;goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_BAD_DATA);this.channelDebug_.xmlHttpChannelResponseText(this.rid_,b,"[Invalid Chunk]");c=!1;break}else this.channelDebug_.xmlHttpChannelResponseText(this.rid_,d,null),this.safeOnRequestData_(d)}a==goog.net.XmlHttp.ReadyState.COMPLETE&&0==b.length&&(this.lastError_=goog.net.ChannelRequest.Error.NO_DATA,goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_NO_DATA),
c=!1);this.successful_=this.successful_&&c;c||(this.channelDebug_.xmlHttpChannelResponseText(this.rid_,b,"[Invalid Chunked Response]"),this.cleanup_(),this.dispatchFailure_())};goog.net.ChannelRequest.prototype.pollResponse_=function(){var a=this.xmlHttp_.getReadyState(),b=this.xmlHttp_.getResponseText();this.xmlHttpChunkStart_<b.length&&(this.cancelWatchDogTimer_(),this.decodeNextChunks_(a,b),this.successful_&&a!=goog.net.XmlHttp.ReadyState.COMPLETE&&this.ensureWatchDogTimer_())};
goog.net.ChannelRequest.prototype.startPolling_=function(){this.eventHandler_.listen(this.pollingTimer_,goog.Timer.TICK,this.pollResponse_);this.pollingTimer_.start()};
goog.net.ChannelRequest.prototype.cancelRequestAsBrowserIsOffline_=function(){this.successful_&&this.channelDebug_.severe("Received browser offline event even though request completed successfully");this.channelDebug_.browserOfflineResponse(this.requestUri_);this.cleanup_();this.lastError_=goog.net.ChannelRequest.Error.BROWSER_OFFLINE;goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.BROWSER_OFFLINE);this.dispatchFailure_()};
goog.net.ChannelRequest.prototype.getNextChunk_=function(a){var b=this.xmlHttpChunkStart_,c=a.indexOf("\n",b);if(-1==c)return goog.net.ChannelRequest.INCOMPLETE_CHUNK_;b=a.substring(b,c);b=Number(b);if(isNaN(b))return goog.net.ChannelRequest.INVALID_CHUNK_;c+=1;if(c+b>a.length)return goog.net.ChannelRequest.INCOMPLETE_CHUNK_;a=a.substr(c,b);this.xmlHttpChunkStart_=c+b;return a};
goog.net.ChannelRequest.prototype.tridentGet=function(a,b){this.type_=goog.net.ChannelRequest.Type_.TRIDENT;this.baseUri_=a.clone().makeUnique();this.tridentGet_(b)};
goog.net.ChannelRequest.prototype.tridentGet_=function(a){this.requestStartTime_=goog.now();this.ensureWatchDogTimer_();var b=a?window.location.hostname:"";this.requestUri_=this.baseUri_.clone();this.requestUri_.setParameterValue("DOMAIN",b);this.requestUri_.setParameterValue("t",this.retryId_);try{this.trident_=new ActiveXObject("htmlfile")}catch(c){this.channelDebug_.severe("ActiveX blocked");this.cleanup_();this.lastError_=goog.net.ChannelRequest.Error.ACTIVE_X_BLOCKED;goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.ACTIVE_X_BLOCKED);
this.dispatchFailure_();return}var d="<html><body>";a&&(d+='<script>document.domain="'+b+'"\x3c/script>');d+="</body></html>";this.trident_.open();this.trident_.write(d);this.trident_.close();this.trident_.parentWindow.m=goog.bind(this.onTridentRpcMessage_,this);this.trident_.parentWindow.d=goog.bind(this.onTridentDone_,this,!0);this.trident_.parentWindow.rpcClose=goog.bind(this.onTridentDone_,this,!1);a=this.trident_.createElement("div");this.trident_.parentWindow.document.body.appendChild(a);a.innerHTML=
'<iframe src="'+this.requestUri_+'"></iframe>';this.channelDebug_.tridentChannelRequest("GET",this.requestUri_,this.rid_,this.retryId_);this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_MADE)};goog.net.ChannelRequest.prototype.onTridentRpcMessage_=function(a){goog.net.BrowserChannel.setTimeout(goog.bind(this.onTridentRpcMessageAsync_,this,a),0)};
goog.net.ChannelRequest.prototype.onTridentRpcMessageAsync_=function(a){this.cancelled_||(this.channelDebug_.tridentChannelResponseText(this.rid_,a),this.cancelWatchDogTimer_(),this.safeOnRequestData_(a),this.ensureWatchDogTimer_())};goog.net.ChannelRequest.prototype.onTridentDone_=function(a){goog.net.BrowserChannel.setTimeout(goog.bind(this.onTridentDoneAsync_,this,a),0)};
goog.net.ChannelRequest.prototype.onTridentDoneAsync_=function(a){this.cancelled_||(this.channelDebug_.tridentChannelResponseDone(this.rid_,a),this.cleanup_(),this.successful_=a,this.channel_.onRequestComplete(this),this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.BACK_CHANNEL_ACTIVITY))};goog.net.ChannelRequest.prototype.sendUsingImgTag=function(a){this.type_=goog.net.ChannelRequest.Type_.IMG;this.baseUri_=a.clone().makeUnique();this.imgTagGet_()};
goog.net.ChannelRequest.prototype.imgTagGet_=function(){(new Image).src=this.baseUri_;this.requestStartTime_=goog.now();this.ensureWatchDogTimer_()};goog.net.ChannelRequest.prototype.cancel=function(){this.cancelled_=!0;this.cleanup_()};goog.net.ChannelRequest.prototype.ensureWatchDogTimer_=function(){this.watchDogTimeoutTime_=goog.now()+this.timeout_;this.startWatchDogTimer_(this.timeout_)};
goog.net.ChannelRequest.prototype.startWatchDogTimer_=function(a){if(null!=this.watchDogTimerId_)throw Error("WatchDog timer not null");this.watchDogTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onWatchDogTimeout_,this),a)};goog.net.ChannelRequest.prototype.cancelWatchDogTimer_=function(){this.watchDogTimerId_&&(goog.global.clearTimeout(this.watchDogTimerId_),this.watchDogTimerId_=null)};
goog.net.ChannelRequest.prototype.onWatchDogTimeout_=function(){this.watchDogTimerId_=null;var a=goog.now();0<=a-this.watchDogTimeoutTime_?this.handleTimeout_():(this.channelDebug_.warning("WatchDog timer called too early"),this.startWatchDogTimer_(this.watchDogTimeoutTime_-a))};
goog.net.ChannelRequest.prototype.handleTimeout_=function(){this.successful_&&this.channelDebug_.severe("Received watchdog timeout even though request loaded successfully");this.channelDebug_.timeoutResponse(this.requestUri_);this.type_!=goog.net.ChannelRequest.Type_.IMG&&this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_FAILED);this.cleanup_();this.lastError_=goog.net.ChannelRequest.Error.TIMEOUT;goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.REQUEST_TIMEOUT);
this.dispatchFailure_()};goog.net.ChannelRequest.prototype.dispatchFailure_=function(){if(!this.channel_.isClosed()&&!this.cancelled_)this.channel_.onRequestComplete(this)};
goog.net.ChannelRequest.prototype.cleanup_=function(){this.cancelWatchDogTimer_();goog.dispose(this.readyStateChangeThrottle_);this.readyStateChangeThrottle_=null;this.pollingTimer_.stop();this.eventHandler_.removeAll();if(this.xmlHttp_){var a=this.xmlHttp_;this.xmlHttp_=null;a.abort();a.dispose()}this.trident_&&(this.trident_=null)};goog.net.ChannelRequest.prototype.getSuccess=function(){return this.successful_};goog.net.ChannelRequest.prototype.getLastError=function(){return this.lastError_};
goog.net.ChannelRequest.prototype.getLastStatusCode=function(){return this.lastStatusCode_};goog.net.ChannelRequest.prototype.getSessionId=function(){return this.sid_};goog.net.ChannelRequest.prototype.getRequestId=function(){return this.rid_};goog.net.ChannelRequest.prototype.getPostData=function(){return this.postData_};goog.net.ChannelRequest.prototype.getRequestStartTime=function(){return this.requestStartTime_};
goog.net.ChannelRequest.prototype.safeOnRequestData_=function(a){try{this.channel_.onRequestData(this,a),this.channel_.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.BACK_CHANNEL_ACTIVITY)}catch(b){this.channelDebug_.dumpException(b,"Error in httprequest callback")}};goog.structs.CircularBuffer=function(a){this.nextPtr_=0;this.maxSize_=a||100;this.buff_=[]};goog.structs.CircularBuffer.prototype.add=function(a){var b=this.buff_[this.nextPtr_];this.buff_[this.nextPtr_]=a;this.nextPtr_=(this.nextPtr_+1)%this.maxSize_;return b};goog.structs.CircularBuffer.prototype.get=function(a){a=this.normalizeIndex_(a);return this.buff_[a]};goog.structs.CircularBuffer.prototype.set=function(a,b){a=this.normalizeIndex_(a);this.buff_[a]=b};
...
goog.structs.CircularBuffer.prototype.getLast=function(){return 0==this.getCount()?null:this.get(this.getCount()-1)};goog.structs.CircularBuffer.prototype.normalizeIndex_=function(a){if(a>=this.buff_.length)throw Error("Out of bounds exception");return this.buff_.length<this.maxSize_?a:(this.nextPtr_+Number(a))%this.maxSize_};goog.net.tmpnetwork={};goog.net.tmpnetwork.GOOGLECOM_TIMEOUT=1E4;goog.net.tmpnetwork.testGoogleCom=function(a,b){var c=b;c||(c=new goog.Uri("//www.google.com/images/cleardot.gif"),c.makeUnique());goog.net.tmpnetwork.testLoadImage(c.toString(),goog.net.tmpnetwork.GOOGLECOM_TIMEOUT,a)};
goog.net.tmpnetwork.testLoadImageWithRetries=function(a,b,c,d,e){(new goog.net.ChannelDebug).debug("TestLoadImageWithRetries: "+e);if(0==d)c(!1);else{var f=e||0;d--;goog.net.tmpnetwork.testLoadImage(a,b,function(e){e?c(!0):goog.global.setTimeout(function(){goog.net.tmpnetwork.testLoadImageWithRetries(a,b,c,d,f)},f)})}};
goog.net.tmpnetwork.testLoadImage=function(a,b,c){var d=new goog.net.ChannelDebug;d.debug("TestLoadImage: loading "+a);var e=new Image;e.onload=function(){try{d.debug("TestLoadImage: loaded"),goog.net.tmpnetwork.clearImageCallbacks_(e),c(!0)}catch(a){d.dumpException(a)}};e.onerror=function(){try{d.debug("TestLoadImage: error"),goog.net.tmpnetwork.clearImageCallbacks_(e),c(!1)}catch(a){d.dumpException(a)}};e.onabort=function(){try{d.debug("TestLoadImage: abort"),goog.net.tmpnetwork.clearImageCallbacks_(e),
c(!1)}catch(a){d.dumpException(a)}};e.ontimeout=function(){try{d.debug("TestLoadImage: timeout"),goog.net.tmpnetwork.clearImageCallbacks_(e),c(!1)}catch(a){d.dumpException(a)}};goog.global.setTimeout(function(){if(e.ontimeout)e.ontimeout()},b);e.src=a};goog.net.tmpnetwork.clearImageCallbacks_=function(a){a.onload=null;a.onerror=null;a.onabort=null;a.ontimeout=null};goog.net.BrowserTestChannel=function(a,b){this.channel_=a;this.channelDebug_=b;this.parser_=new goog.json.EvalJsonProcessor(null,!0)};goog.net.BrowserTestChannel.prototype.extraHeaders_=null;goog.net.BrowserTestChannel.prototype.request_=null;goog.net.BrowserTestChannel.prototype.receivedIntermediateResult_=!1;goog.net.BrowserTestChannel.prototype.startTime_=null;goog.net.BrowserTestChannel.prototype.firstTime_=null;goog.net.BrowserTestChannel.prototype.lastTime_=null;
goog.net.BrowserTestChannel.prototype.path_=null;goog.net.BrowserTestChannel.prototype.state_=null;goog.net.BrowserTestChannel.prototype.lastStatusCode_=-1;goog.net.BrowserTestChannel.prototype.hostPrefix_=null;goog.net.BrowserTestChannel.prototype.blockedPrefix_=null;goog.net.BrowserTestChannel.State_={INIT:0,CHECKING_BLOCKED:1,CONNECTION_TESTING:2};goog.net.BrowserTestChannel.BLOCKED_TIMEOUT_=5E3;goog.net.BrowserTestChannel.BLOCKED_RETRIES_=3;
goog.net.BrowserTestChannel.BLOCKED_PAUSE_BETWEEN_RETRIES_=2E3;goog.net.BrowserTestChannel.MIN_TIME_EXPECTED_BETWEEN_DATA_=500;goog.net.BrowserTestChannel.prototype.setExtraHeaders=function(a){this.extraHeaders_=a};goog.net.BrowserTestChannel.prototype.setParser=function(a){this.parser_=a};
goog.net.BrowserTestChannel.prototype.connect=function(a){this.path_=a;a=this.channel_.getForwardChannelUri(this.path_);goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_ONE_START);this.startTime_=goog.now();var b=this.channel_.getFirstTestResults();goog.isDefAndNotNull(b)?(this.hostPrefix_=this.channel_.correctHostPrefix(b[0]),(this.blockedPrefix_=b[1])?(this.state_=goog.net.BrowserTestChannel.State_.CHECKING_BLOCKED,this.checkBlocked_()):(this.state_=goog.net.BrowserTestChannel.State_.CONNECTION_TESTING,
this.connectStage2_())):(a.setParameterValues("MODE","init"),this.request_=goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_),this.request_.setExtraHeaders(this.extraHeaders_),this.request_.xmlHttpGet(a,!1,null,!0),this.state_=goog.net.BrowserTestChannel.State_.INIT)};
goog.net.BrowserTestChannel.prototype.checkBlocked_=function(){var a=this.channel_.createDataUri(this.blockedPrefix_,"/mail/images/cleardot.gif");a.makeUnique();goog.net.tmpnetwork.testLoadImageWithRetries(a.toString(),goog.net.BrowserTestChannel.BLOCKED_TIMEOUT_,goog.bind(this.checkBlockedCallback_,this),goog.net.BrowserTestChannel.BLOCKED_RETRIES_,goog.net.BrowserTestChannel.BLOCKED_PAUSE_BETWEEN_RETRIES_);this.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_MADE)};
goog.net.BrowserTestChannel.prototype.checkBlockedCallback_=function(a){a?(this.state_=goog.net.BrowserTestChannel.State_.CONNECTION_TESTING,this.connectStage2_()):(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.CHANNEL_BLOCKED),this.channel_.testConnectionBlocked(this));a&&this.notifyServerReachabilityEvent(goog.net.BrowserChannel.ServerReachability.REQUEST_SUCCEEDED)};
goog.net.BrowserTestChannel.prototype.connectStage2_=function(){this.channelDebug_.debug("TestConnection: starting stage 2");var a=this.channel_.getSecondTestResults();goog.isDefAndNotNull(a)?(this.channelDebug_.debug("TestConnection: skipping stage 2, precomputed result is "+a?"Buffered":"Unbuffered"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_START),a?(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.PROXY),this.channel_.testConnectionFinished(this,
!1)):(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY),this.channel_.testConnectionFinished(this,!0))):(this.request_=goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_),this.request_.setExtraHeaders(this.extraHeaders_),a=this.channel_.getBackChannelUri(this.hostPrefix_,this.path_),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_START),goog.net.ChannelRequest.supportsXhrStreaming()?(a.setParameterValues("TYPE","xmlhttp"),
this.request_.xmlHttpGet(a,!1,this.hostPrefix_,!1)):(a.setParameterValues("TYPE","html"),this.request_.tridentGet(a,Boolean(this.hostPrefix_))))};goog.net.BrowserTestChannel.prototype.createXhrIo=function(a){return this.channel_.createXhrIo(a)};goog.net.BrowserTestChannel.prototype.abort=function(){this.request_&&(this.request_.cancel(),this.request_=null);this.lastStatusCode_=-1};goog.net.BrowserTestChannel.prototype.isClosed=function(){return!1};
goog.net.BrowserTestChannel.prototype.onRequestData=function(a,b){this.lastStatusCode_=a.getLastStatusCode();if(this.state_==goog.net.BrowserTestChannel.State_.INIT)if(this.channelDebug_.debug("TestConnection: Got data for stage 1"),b){try{var c=this.parser_.parse(b)}catch(d){this.channelDebug_.dumpException(d);this.channel_.testConnectionFailure(this,goog.net.ChannelRequest.Error.BAD_DATA);return}this.hostPrefix_=this.channel_.correctHostPrefix(c[0]);this.blockedPrefix_=c[1]}else this.channelDebug_.debug("TestConnection: Null responseText"),
this.channel_.testConnectionFailure(this,goog.net.ChannelRequest.Error.BAD_DATA);else this.state_==goog.net.BrowserTestChannel.State_.CONNECTION_TESTING&&(this.receivedIntermediateResult_?(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_TWO),this.lastTime_=goog.now()):"11111"==b?(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_ONE),this.receivedIntermediateResult_=!0,this.firstTime_=goog.now(),this.checkForEarlyNonBuffered_()&&
(this.lastStatusCode_=200,this.request_.cancel(),this.channelDebug_.debug("Test connection succeeded; using streaming connection"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY),this.channel_.testConnectionFinished(this,!0))):(goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.TEST_STAGE_TWO_DATA_BOTH),this.firstTime_=this.lastTime_=goog.now(),this.receivedIntermediateResult_=!1))};
goog.net.BrowserTestChannel.prototype.onRequestComplete=function(a){this.lastStatusCode_=this.request_.getLastStatusCode();this.request_.getSuccess()?this.state_==goog.net.BrowserTestChannel.State_.INIT?(this.channelDebug_.debug("TestConnection: request complete for initial check"),this.blockedPrefix_?(this.state_=goog.net.BrowserTestChannel.State_.CHECKING_BLOCKED,this.checkBlocked_()):(this.state_=goog.net.BrowserTestChannel.State_.CONNECTION_TESTING,this.connectStage2_())):this.state_==goog.net.BrowserTestChannel.State_.CONNECTION_TESTING&&
(this.channelDebug_.debug("TestConnection: request complete for stage 2"),a=!1,(a=goog.net.ChannelRequest.supportsXhrStreaming()?this.receivedIntermediateResult_:200>this.lastTime_-this.firstTime_?!1:!0)?(this.channelDebug_.debug("Test connection succeeded; using streaming connection"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.NOPROXY),this.channel_.testConnectionFinished(this,!0)):(this.channelDebug_.debug("Test connection failed; not using streaming"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.PROXY),
...
goog.net.BrowserTestChannel.prototype.getLastStatusCode=function(){return this.lastStatusCode_};goog.net.BrowserTestChannel.prototype.shouldUseSecondaryDomains=function(){return this.channel_.shouldUseSecondaryDomains()};goog.net.BrowserTestChannel.prototype.isActive=function(a){return this.channel_.isActive()};goog.net.BrowserTestChannel.prototype.checkForEarlyNonBuffered_=function(){var a=this.firstTime_-this.startTime_;return goog.net.ChannelRequest.supportsXhrStreaming()||a<goog.net.BrowserTestChannel.MIN_TIME_EXPECTED_BETWEEN_DATA_};
goog.net.BrowserTestChannel.prototype.notifyServerReachabilityEvent=function(a){this.channel_.notifyServerReachabilityEvent(a)};goog.net.BrowserChannel=function(a,b,c){this.clientVersion_=a||null;this.state_=goog.net.BrowserChannel.State.INIT;this.outgoingMaps_=[];this.pendingMaps_=[];this.channelDebug_=new goog.net.ChannelDebug;this.parser_=new goog.json.EvalJsonProcessor(null,!0);this.firstTestResults_=b||null;this.secondTestResults_=goog.isDefAndNotNull(c)?c:null};goog.net.BrowserChannel.QueuedMap=function(a,b,c){this.mapId=a;this.map=b;this.context=c||null};goog.net.BrowserChannel.prototype.extraHeaders_=null;
goog.net.BrowserChannel.prototype.extraParams_=null;goog.net.BrowserChannel.prototype.forwardChannelRequest_=null;goog.net.BrowserChannel.prototype.backChannelRequest_=null;goog.net.BrowserChannel.prototype.path_=null;goog.net.BrowserChannel.prototype.forwardChannelUri_=null;goog.net.BrowserChannel.prototype.backChannelUri_=null;goog.net.BrowserChannel.prototype.hostPrefix_=null;goog.net.BrowserChannel.prototype.allowHostPrefix_=!0;goog.net.BrowserChannel.prototype.nextRid_=0;
goog.net.BrowserChannel.prototype.nextMapId_=0;goog.net.BrowserChannel.prototype.failFast_=!1;goog.net.BrowserChannel.prototype.handler_=null;goog.net.BrowserChannel.prototype.forwardChannelTimerId_=null;goog.net.BrowserChannel.prototype.backChannelTimerId_=null;goog.net.BrowserChannel.prototype.deadBackChannelTimerId_=null;goog.net.BrowserChannel.prototype.connectionTest_=null;goog.net.BrowserChannel.prototype.useChunked_=null;goog.net.BrowserChannel.prototype.allowChunkedMode_=!0;
goog.net.BrowserChannel.prototype.lastArrayId_=-1;goog.net.BrowserChannel.prototype.lastPostResponseArrayId_=-1;goog.net.BrowserChannel.prototype.lastStatusCode_=-1;goog.net.BrowserChannel.prototype.forwardChannelRetryCount_=0;goog.net.BrowserChannel.prototype.backChannelRetryCount_=0;goog.net.BrowserChannel.prototype.baseRetryDelayMs_=5E3;goog.net.BrowserChannel.prototype.retryDelaySeedMs_=1E4;goog.net.BrowserChannel.prototype.forwardChannelMaxRetries_=2;
goog.net.BrowserChannel.prototype.forwardChannelRequestTimeoutMs_=2E4;goog.net.BrowserChannel.prototype.readyStateChangeThrottleMs_=0;goog.net.BrowserChannel.prototype.supportsCrossDomainXhrs_=!1;goog.net.BrowserChannel.LATEST_CHANNEL_VERSION=8;goog.net.BrowserChannel.prototype.channelVersion_=goog.net.BrowserChannel.LATEST_CHANNEL_VERSION;goog.net.BrowserChannel.State={CLOSED:0,INIT:1,OPENING:2,OPENED:3};goog.net.BrowserChannel.FORWARD_CHANNEL_RETRY_TIMEOUT=2E4;
goog.net.BrowserChannel.BACK_CHANNEL_MAX_RETRIES=3;goog.net.BrowserChannel.RTT_ESTIMATE=3E3;goog.net.BrowserChannel.INACTIVE_CHANNEL_RETRY_FACTOR=2;goog.net.BrowserChannel.Error={OK:0,REQUEST_FAILED:2,LOGGED_OUT:4,NO_DATA:5,UNKNOWN_SESSION_ID:6,STOP:7,NETWORK:8,BLOCKED:9,BAD_DATA:10,BAD_RESPONSE:11,ACTIVE_X_BLOCKED:12};goog.net.BrowserChannel.ChannelType_={FORWARD_CHANNEL:1,BACK_CHANNEL:2};goog.net.BrowserChannel.MAX_MAPS_PER_REQUEST_=1E3;goog.net.BrowserChannel.statEventTarget_=new goog.events.EventTarget;
goog.net.BrowserChannel.Event={};goog.net.BrowserChannel.Event.STAT_EVENT="statevent";goog.net.BrowserChannel.StatEvent=function(a,b){goog.events.Event.call(this,goog.net.BrowserChannel.Event.STAT_EVENT,a);this.stat=b};goog.inherits(goog.net.BrowserChannel.StatEvent,goog.events.Event);goog.net.BrowserChannel.Event.TIMING_EVENT="timingevent";
goog.net.BrowserChannel.TimingEvent=function(a,b,c,d){goog.events.Event.call(this,goog.net.BrowserChannel.Event.TIMING_EVENT,a);this.size=b;this.rtt=c;this.retries=d};goog.inherits(goog.net.BrowserChannel.TimingEvent,goog.events.Event);goog.net.BrowserChannel.Event.SERVER_REACHABILITY_EVENT="serverreachability";goog.net.BrowserChannel.ServerReachability={REQUEST_MADE:1,REQUEST_SUCCEEDED:2,REQUEST_FAILED:3,BACK_CHANNEL_ACTIVITY:4};
goog.net.BrowserChannel.ServerReachabilityEvent=function(a,b){goog.events.Event.call(this,goog.net.BrowserChannel.Event.SERVER_REACHABILITY_EVENT,a);this.reachabilityType=b};goog.inherits(goog.net.BrowserChannel.ServerReachabilityEvent,goog.events.Event);
goog.net.BrowserChannel.Stat={CONNECT_ATTEMPT:0,ERROR_NETWORK:1,ERROR_OTHER:2,TEST_STAGE_ONE_START:3,CHANNEL_BLOCKED:4,TEST_STAGE_TWO_START:5,TEST_STAGE_TWO_DATA_ONE:6,TEST_STAGE_TWO_DATA_TWO:7,TEST_STAGE_TWO_DATA_BOTH:8,TEST_STAGE_ONE_FAILED:9,TEST_STAGE_TWO_FAILED:10,PROXY:11,NOPROXY:12,REQUEST_UNKNOWN_SESSION_ID:13,REQUEST_BAD_STATUS:14,REQUEST_INCOMPLETE_DATA:15,REQUEST_BAD_DATA:16,REQUEST_NO_DATA:17,REQUEST_TIMEOUT:18,BACKCHANNEL_MISSING:19,BACKCHANNEL_DEAD:20,BROWSER_OFFLINE:21,ACTIVE_X_BLOCKED:22};
goog.net.BrowserChannel.MAGIC_RESPONSE_COOKIE="y2f%";goog.net.BrowserChannel.OUTSTANDING_DATA_BACKCHANNEL_RETRY_CUTOFF=37500;goog.net.BrowserChannel.prototype.getChannelDebug=function(){return this.channelDebug_};goog.net.BrowserChannel.prototype.setChannelDebug=function(a){goog.isDefAndNotNull(a)&&(this.channelDebug_=a)};goog.net.BrowserChannel.setStartThreadExecutionHook=function(a){goog.net.BrowserChannel.startExecutionHook_=a};
goog.net.BrowserChannel.setEndThreadExecutionHook=function(a){goog.net.BrowserChannel.endExecutionHook_=a};goog.net.BrowserChannel.startExecutionHook_=function(){};goog.net.BrowserChannel.endExecutionHook_=function(){};goog.net.BrowserChannel.createChannelRequest=function(a,b,c,d,e){return new goog.net.ChannelRequest(a,b,c,d,e)};
goog.net.BrowserChannel.prototype.connect=function(a,b,c,d,e){this.channelDebug_.debug("connect()");goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.CONNECT_ATTEMPT);this.path_=b;this.extraParams_=c||{};d&&goog.isDef(e)&&(this.extraParams_.OSID=d,this.extraParams_.OAID=e);this.connectTest_(a)};
goog.net.BrowserChannel.prototype.disconnect=function(){this.channelDebug_.debug("disconnect()");this.cancelRequests_();if(this.state_==goog.net.BrowserChannel.State.OPENED){var a=this.nextRid_++,b=this.forwardChannelUri_.clone();b.setParameterValue("SID",this.sid_);b.setParameterValue("RID",a);b.setParameterValue("TYPE","terminate");this.addAdditionalParams_(b);goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_,this.sid_,a).sendUsingImgTag(b)}this.onClose_()};
goog.net.BrowserChannel.prototype.getSessionId=function(){return this.sid_};goog.net.BrowserChannel.prototype.connectTest_=function(a){this.channelDebug_.debug("connectTest_()");this.okToMakeRequest_()&&(this.connectionTest_=new goog.net.BrowserTestChannel(this,this.channelDebug_),this.connectionTest_.setExtraHeaders(this.extraHeaders_),this.connectionTest_.setParser(this.parser_),this.connectionTest_.connect(a))};
goog.net.BrowserChannel.prototype.connectChannel_=function(){this.channelDebug_.debug("connectChannel_()");this.ensureInState_(goog.net.BrowserChannel.State.INIT,goog.net.BrowserChannel.State.CLOSED);this.forwardChannelUri_=this.getForwardChannelUri(this.path_);this.ensureForwardChannel_()};
goog.net.BrowserChannel.prototype.cancelRequests_=function(){this.connectionTest_&&(this.connectionTest_.abort(),this.connectionTest_=null);this.backChannelRequest_&&(this.backChannelRequest_.cancel(),this.backChannelRequest_=null);this.backChannelTimerId_&&(goog.global.clearTimeout(this.backChannelTimerId_),this.backChannelTimerId_=null);this.clearDeadBackchannelTimer_();this.forwardChannelRequest_&&(this.forwardChannelRequest_.cancel(),this.forwardChannelRequest_=null);this.forwardChannelTimerId_&&
(goog.global.clearTimeout(this.forwardChannelTimerId_),this.forwardChannelTimerId_=null)};goog.net.BrowserChannel.prototype.getExtraHeaders=function(){return this.extraHeaders_};goog.net.BrowserChannel.prototype.setExtraHeaders=function(a){this.extraHeaders_=a};goog.net.BrowserChannel.prototype.setReadyStateChangeThrottle=function(a){this.readyStateChangeThrottleMs_=a};goog.net.BrowserChannel.prototype.setSupportsCrossDomainXhrs=function(a){this.supportsCrossDomainXhrs_=a};
goog.net.BrowserChannel.prototype.getHandler=function(){return this.handler_};goog.net.BrowserChannel.prototype.setHandler=function(a){this.handler_=a};goog.net.BrowserChannel.prototype.getAllowHostPrefix=function(){return this.allowHostPrefix_};goog.net.BrowserChannel.prototype.setAllowHostPrefix=function(a){this.allowHostPrefix_=a};goog.net.BrowserChannel.prototype.isBuffered=function(){return!this.useChunked_};goog.net.BrowserChannel.prototype.getAllowChunkedMode=function(){return this.allowChunkedMode_};
goog.net.BrowserChannel.prototype.setAllowChunkedMode=function(a){this.allowChunkedMode_=a};
goog.net.BrowserChannel.prototype.sendMap=function(a,b){if(this.state_==goog.net.BrowserChannel.State.CLOSED)throw Error("Invalid operation: sending map when state is closed");this.outgoingMaps_.length==goog.net.BrowserChannel.MAX_MAPS_PER_REQUEST_&&this.channelDebug_.severe("Already have "+goog.net.BrowserChannel.MAX_MAPS_PER_REQUEST_+" queued maps upon queueing "+goog.json.serialize(a));this.outgoingMaps_.push(new goog.net.BrowserChannel.QueuedMap(this.nextMapId_++,a,b));this.state_!=goog.net.BrowserChannel.State.OPENING&&
this.state_!=goog.net.BrowserChannel.State.OPENED||this.ensureForwardChannel_()};
goog.net.BrowserChannel.prototype.setFailFast=function(a){this.failFast_=a;this.channelDebug_.info("setFailFast: "+a);(this.forwardChannelRequest_||this.forwardChannelTimerId_)&&this.forwardChannelRetryCount_>this.getForwardChannelMaxRetries()&&(this.channelDebug_.info("Retry count "+this.forwardChannelRetryCount_+" > new maxRetries "+this.getForwardChannelMaxRetries()+". Fail immediately!"),this.forwardChannelRequest_?(this.forwardChannelRequest_.cancel(),this.onRequestComplete(this.forwardChannelRequest_)):
(goog.global.clearTimeout(this.forwardChannelTimerId_),this.forwardChannelTimerId_=null,this.signalError_(goog.net.BrowserChannel.Error.REQUEST_FAILED)))};goog.net.BrowserChannel.prototype.getForwardChannelMaxRetries=function(){return this.failFast_?0:this.forwardChannelMaxRetries_};goog.net.BrowserChannel.prototype.setForwardChannelMaxRetries=function(a){this.forwardChannelMaxRetries_=a};
goog.net.BrowserChannel.prototype.setForwardChannelRequestTimeout=function(a){this.forwardChannelRequestTimeoutMs_=a};goog.net.BrowserChannel.prototype.getBackChannelMaxRetries=function(){return goog.net.BrowserChannel.BACK_CHANNEL_MAX_RETRIES};goog.net.BrowserChannel.prototype.isClosed=function(){return this.state_==goog.net.BrowserChannel.State.CLOSED};goog.net.BrowserChannel.prototype.getState=function(){return this.state_};goog.net.BrowserChannel.prototype.getLastStatusCode=function(){return this.lastStatusCode_};
goog.net.BrowserChannel.prototype.getLastArrayId=function(){return this.lastArrayId_};goog.net.BrowserChannel.prototype.hasOutstandingRequests=function(){return 0!=this.outstandingRequests_()};goog.net.BrowserChannel.prototype.setParser=function(a){this.parser_=a};goog.net.BrowserChannel.prototype.outstandingRequests_=function(){var a=0;this.backChannelRequest_&&a++;this.forwardChannelRequest_&&a++;return a};
goog.net.BrowserChannel.prototype.ensureForwardChannel_=function(){this.forwardChannelRequest_||this.forwardChannelTimerId_||(this.forwardChannelTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartForwardChannelTimer_,this),0),this.forwardChannelRetryCount_=0)};
goog.net.BrowserChannel.prototype.maybeRetryForwardChannel_=function(a){if(this.forwardChannelRequest_||this.forwardChannelTimerId_)return this.channelDebug_.severe("Request already in progress"),!1;if(this.state_==goog.net.BrowserChannel.State.INIT||this.forwardChannelRetryCount_>=this.getForwardChannelMaxRetries())return!1;this.channelDebug_.debug("Going to retry POST");this.forwardChannelTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartForwardChannelTimer_,this,a),this.getRetryTime_(this.forwardChannelRetryCount_));
this.forwardChannelRetryCount_++;return!0};goog.net.BrowserChannel.prototype.onStartForwardChannelTimer_=function(a){this.forwardChannelTimerId_=null;this.startForwardChannel_(a)};
goog.net.BrowserChannel.prototype.startForwardChannel_=function(a){this.channelDebug_.debug("startForwardChannel_");this.okToMakeRequest_()&&(this.state_==goog.net.BrowserChannel.State.INIT?a?this.channelDebug_.severe("Not supposed to retry the open"):(this.open_(),this.state_=goog.net.BrowserChannel.State.OPENING):this.state_==goog.net.BrowserChannel.State.OPENED&&(a?this.makeForwardChannelRequest_(a):0==this.outgoingMaps_.length?this.channelDebug_.debug("startForwardChannel_ returned: nothing to send"):
this.forwardChannelRequest_?this.channelDebug_.severe("startForwardChannel_ returned: connection already in progress"):(this.makeForwardChannelRequest_(),this.channelDebug_.debug("startForwardChannel_ finished, sent request"))))};
goog.net.BrowserChannel.prototype.open_=function(){this.channelDebug_.debug("open_()");this.nextRid_=Math.floor(1E5*Math.random());var a=this.nextRid_++,b=goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_,"",a);b.setExtraHeaders(this.extraHeaders_);var c=this.dequeueOutgoingMaps_(),d=this.forwardChannelUri_.clone();d.setParameterValue("RID",a);this.clientVersion_&&d.setParameterValue("CVER",this.clientVersion_);this.addAdditionalParams_(d);b.xmlHttpPost(d,c,!0);this.forwardChannelRequest_=
b};
goog.net.BrowserChannel.prototype.makeForwardChannelRequest_=function(a){var b;a?6<this.channelVersion_?(this.requeuePendingMaps_(),b=this.nextRid_-1,a=this.dequeueOutgoingMaps_()):(b=a.getRequestId(),a=a.getPostData()):(b=this.nextRid_++,a=this.dequeueOutgoingMaps_());var c=this.forwardChannelUri_.clone();c.setParameterValue("SID",this.sid_);c.setParameterValue("RID",b);c.setParameterValue("AID",this.lastArrayId_);this.addAdditionalParams_(c);b=goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_,
this.sid_,b,this.forwardChannelRetryCount_+1);b.setExtraHeaders(this.extraHeaders_);b.setTimeout(Math.round(0.5*this.forwardChannelRequestTimeoutMs_)+Math.round(0.5*this.forwardChannelRequestTimeoutMs_*Math.random()));this.forwardChannelRequest_=b;b.xmlHttpPost(c,a,!0)};goog.net.BrowserChannel.prototype.addAdditionalParams_=function(a){if(this.handler_){var b=this.handler_.getAdditionalParams(this);b&&goog.structs.forEach(b,function(b,d,e){a.setParameterValue(d,b)})}};
goog.net.BrowserChannel.prototype.dequeueOutgoingMaps_=function(){var a=Math.min(this.outgoingMaps_.length,goog.net.BrowserChannel.MAX_MAPS_PER_REQUEST_),b=["count="+a],c;6<this.channelVersion_&&0<a?(c=this.outgoingMaps_[0].mapId,b.push("ofs="+c)):c=0;for(var d=0;d<a;d++){var e=this.outgoingMaps_[d].mapId,f=this.outgoingMaps_[d].map,e=6>=this.channelVersion_?d:e-c;try{goog.structs.forEach(f,function(a,c,d){b.push("req"+e+"_"+c+"="+encodeURIComponent(a))})}catch(g){b.push("req"+e+"_type="+encodeURIComponent("_badmap")),
this.handler_&&this.handler_.badMapError(this,f)}}this.pendingMaps_=this.pendingMaps_.concat(this.outgoingMaps_.splice(0,a));return b.join("&")};goog.net.BrowserChannel.prototype.requeuePendingMaps_=function(){this.outgoingMaps_=this.pendingMaps_.concat(this.outgoingMaps_);this.pendingMaps_.length=0};
goog.net.BrowserChannel.prototype.ensureBackChannel_=function(){this.backChannelRequest_||this.backChannelTimerId_||(this.backChannelAttemptId_=1,this.backChannelTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartBackChannelTimer_,this),0),this.backChannelRetryCount_=0)};
goog.net.BrowserChannel.prototype.maybeRetryBackChannel_=function(){if(this.backChannelRequest_||this.backChannelTimerId_)return this.channelDebug_.severe("Request already in progress"),!1;if(this.backChannelRetryCount_>=this.getBackChannelMaxRetries())return!1;this.channelDebug_.debug("Going to retry GET");this.backChannelAttemptId_++;this.backChannelTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onStartBackChannelTimer_,this),this.getRetryTime_(this.backChannelRetryCount_));this.backChannelRetryCount_++;
return!0};goog.net.BrowserChannel.prototype.onStartBackChannelTimer_=function(){this.backChannelTimerId_=null;this.startBackChannel_()};
goog.net.BrowserChannel.prototype.startBackChannel_=function(){if(this.okToMakeRequest_()){this.channelDebug_.debug("Creating new HttpRequest");this.backChannelRequest_=goog.net.BrowserChannel.createChannelRequest(this,this.channelDebug_,this.sid_,"rpc",this.backChannelAttemptId_);this.backChannelRequest_.setExtraHeaders(this.extraHeaders_);this.backChannelRequest_.setReadyStateChangeThrottle(this.readyStateChangeThrottleMs_);var a=this.backChannelUri_.clone();a.setParameterValue("RID","rpc");a.setParameterValue("SID",
this.sid_);a.setParameterValue("CI",this.useChunked_?"0":"1");a.setParameterValue("AID",this.lastArrayId_);this.addAdditionalParams_(a);goog.net.ChannelRequest.supportsXhrStreaming()?(a.setParameterValue("TYPE","xmlhttp"),this.backChannelRequest_.xmlHttpGet(a,!0,this.hostPrefix_,!1)):(a.setParameterValue("TYPE","html"),this.backChannelRequest_.tridentGet(a,Boolean(this.hostPrefix_)));this.channelDebug_.debug("New Request created")}};
goog.net.BrowserChannel.prototype.okToMakeRequest_=function(){if(this.handler_){var a=this.handler_.okToMakeRequest(this);if(a!=goog.net.BrowserChannel.Error.OK)return this.channelDebug_.debug("Handler returned error code from okToMakeRequest"),this.signalError_(a),!1}return!0};goog.net.BrowserChannel.prototype.testConnectionFinished=function(a,b){this.channelDebug_.debug("Test Connection Finished");this.useChunked_=this.allowChunkedMode_&&b;this.lastStatusCode_=a.getLastStatusCode();this.connectChannel_()};
goog.net.BrowserChannel.prototype.testConnectionFailure=function(a,b){this.channelDebug_.debug("Test Connection Failed");this.lastStatusCode_=a.getLastStatusCode();this.signalError_(goog.net.BrowserChannel.Error.REQUEST_FAILED)};goog.net.BrowserChannel.prototype.testConnectionBlocked=function(a){this.channelDebug_.debug("Test Connection Blocked");this.lastStatusCode_=this.connectionTest_.getLastStatusCode();this.signalError_(goog.net.BrowserChannel.Error.BLOCKED)};
goog.net.BrowserChannel.prototype.onRequestData=function(a,b){if(this.state_!=goog.net.BrowserChannel.State.CLOSED&&(this.backChannelRequest_==a||this.forwardChannelRequest_==a))if(this.lastStatusCode_=a.getLastStatusCode(),this.forwardChannelRequest_==a&&this.state_==goog.net.BrowserChannel.State.OPENED)if(7<this.channelVersion_){var c;try{c=this.parser_.parse(b)}catch(d){c=null}goog.isArray(c)&&3==c.length?this.handlePostResponse_(c):(this.channelDebug_.debug("Bad POST response data returned"),
this.signalError_(goog.net.BrowserChannel.Error.BAD_RESPONSE))}else b!=goog.net.BrowserChannel.MAGIC_RESPONSE_COOKIE&&(this.channelDebug_.debug("Bad data returned - missing/invald magic cookie"),this.signalError_(goog.net.BrowserChannel.Error.BAD_RESPONSE));else this.backChannelRequest_==a&&this.clearDeadBackchannelTimer_(),goog.string.isEmpty(b)||(c=this.parser_.parse(b),goog.asserts.assert(goog.isArray(c)),this.onInput_(c))};
goog.net.BrowserChannel.prototype.handlePostResponse_=function(a){if(0==a[0])this.handleBackchannelMissing_();else{this.lastPostResponseArrayId_=a[1];var b=this.lastPostResponseArrayId_-this.lastArrayId_;0<b&&(a=a[2],this.channelDebug_.debug(a+" bytes (in "+b+" arrays) are outstanding on the BackChannel"),this.shouldRetryBackChannel_(a)&&!this.deadBackChannelTimerId_&&(this.deadBackChannelTimerId_=goog.net.BrowserChannel.setTimeout(goog.bind(this.onBackChannelDead_,this),2*goog.net.BrowserChannel.RTT_ESTIMATE)))}};
goog.net.BrowserChannel.prototype.handleBackchannelMissing_=function(){this.channelDebug_.debug("Server claims our backchannel is missing.");if(this.backChannelTimerId_)this.channelDebug_.debug("But we are currently starting the request.");else{if(this.backChannelRequest_)if(this.backChannelRequest_.getRequestStartTime()+goog.net.BrowserChannel.RTT_ESTIMATE<this.forwardChannelRequest_.getRequestStartTime())this.clearDeadBackchannelTimer_(),this.backChannelRequest_.cancel(),this.backChannelRequest_=
null;else return;else this.channelDebug_.warning("We do not have a BackChannel established");this.maybeRetryBackChannel_();goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.BACKCHANNEL_MISSING)}};goog.net.BrowserChannel.prototype.shouldRetryBackChannel_=function(a){return a<goog.net.BrowserChannel.OUTSTANDING_DATA_BACKCHANNEL_RETRY_CUTOFF&&!this.isBuffered()&&0==this.backChannelRetryCount_};
goog.net.BrowserChannel.prototype.correctHostPrefix=function(a){return this.allowHostPrefix_?this.handler_?this.handler_.correctHostPrefix(a):a:null};goog.net.BrowserChannel.prototype.onBackChannelDead_=function(){goog.isDefAndNotNull(this.deadBackChannelTimerId_)&&(this.deadBackChannelTimerId_=null,this.backChannelRequest_.cancel(),this.backChannelRequest_=null,this.maybeRetryBackChannel_(),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.BACKCHANNEL_DEAD))};
goog.net.BrowserChannel.prototype.clearDeadBackchannelTimer_=function(){goog.isDefAndNotNull(this.deadBackChannelTimerId_)&&(goog.global.clearTimeout(this.deadBackChannelTimerId_),this.deadBackChannelTimerId_=null)};goog.net.BrowserChannel.isFatalError_=function(a,b){return a==goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID||a==goog.net.ChannelRequest.Error.ACTIVE_X_BLOCKED||a==goog.net.ChannelRequest.Error.STATUS&&0<b};
goog.net.BrowserChannel.prototype.onRequestComplete=function(a){this.channelDebug_.debug("Request complete");var b;if(this.backChannelRequest_==a)this.clearDeadBackchannelTimer_(),this.backChannelRequest_=null,b=goog.net.BrowserChannel.ChannelType_.BACK_CHANNEL;else if(this.forwardChannelRequest_==a)this.forwardChannelRequest_=null,b=goog.net.BrowserChannel.ChannelType_.FORWARD_CHANNEL;else return;this.lastStatusCode_=a.getLastStatusCode();if(this.state_!=goog.net.BrowserChannel.State.CLOSED)if(a.getSuccess())b==
goog.net.BrowserChannel.ChannelType_.FORWARD_CHANNEL?(b=a.getPostData()?a.getPostData().length:0,goog.net.BrowserChannel.notifyTimingEvent(b,goog.now()-a.getRequestStartTime(),this.forwardChannelRetryCount_),this.ensureForwardChannel_(),this.onSuccess_(),this.pendingMaps_.length=0):this.ensureBackChannel_();else{var c=a.getLastError();if(goog.net.BrowserChannel.isFatalError_(c,this.lastStatusCode_))this.channelDebug_.debug("Not retrying due to error type");else{this.channelDebug_.debug("Maybe retrying, last error: "+
goog.net.ChannelRequest.errorStringFromCode(c,this.lastStatusCode_));if(b==goog.net.BrowserChannel.ChannelType_.FORWARD_CHANNEL&&this.maybeRetryForwardChannel_(a)||b==goog.net.BrowserChannel.ChannelType_.BACK_CHANNEL&&this.maybeRetryBackChannel_())return;this.channelDebug_.debug("Exceeded max number of retries")}this.channelDebug_.debug("Error: HTTP request failed");switch(c){case goog.net.ChannelRequest.Error.NO_DATA:this.signalError_(goog.net.BrowserChannel.Error.NO_DATA);break;case goog.net.ChannelRequest.Error.BAD_DATA:this.signalError_(goog.net.BrowserChannel.Error.BAD_DATA);
break;case goog.net.ChannelRequest.Error.UNKNOWN_SESSION_ID:this.signalError_(goog.net.BrowserChannel.Error.UNKNOWN_SESSION_ID);break;case goog.net.ChannelRequest.Error.ACTIVE_X_BLOCKED:this.signalError_(goog.net.BrowserChannel.Error.ACTIVE_X_BLOCKED);break;default:this.signalError_(goog.net.BrowserChannel.Error.REQUEST_FAILED)}}};
goog.net.BrowserChannel.prototype.getRetryTime_=function(a){var b=this.baseRetryDelayMs_+Math.floor(Math.random()*this.retryDelaySeedMs_);this.isActive()||(this.channelDebug_.debug("Inactive channel"),b*=goog.net.BrowserChannel.INACTIVE_CHANNEL_RETRY_FACTOR);return b*a};goog.net.BrowserChannel.prototype.setRetryDelay=function(a,b){this.baseRetryDelayMs_=a;this.retryDelaySeedMs_=b};
goog.net.BrowserChannel.prototype.onInput_=function(a){for(var b=this.handler_&&this.handler_.channelHandleMultipleArrays?[]:null,c=0;c<a.length;c++){var d=a[c];this.lastArrayId_=d[0];d=d[1];this.state_==goog.net.BrowserChannel.State.OPENING?"c"==d[0]?(this.sid_=d[1],this.hostPrefix_=this.correctHostPrefix(d[2]),d=d[3],goog.isDefAndNotNull(d)?this.channelVersion_=d:this.channelVersion_=6,this.state_=goog.net.BrowserChannel.State.OPENED,this.handler_&&this.handler_.channelOpened(this),this.backChannelUri_=
this.getBackChannelUri(this.hostPrefix_,this.path_),this.ensureBackChannel_()):"stop"==d[0]&&this.signalError_(goog.net.BrowserChannel.Error.STOP):this.state_==goog.net.BrowserChannel.State.OPENED&&("stop"==d[0]?(b&&!goog.array.isEmpty(b)&&(this.handler_.channelHandleMultipleArrays(this,b),b.length=0),this.signalError_(goog.net.BrowserChannel.Error.STOP)):"noop"!=d[0]&&(b?b.push(d):this.handler_&&this.handler_.channelHandleArray(this,d)),this.backChannelRetryCount_=0)}b&&!goog.array.isEmpty(b)&&this.handler_.channelHandleMultipleArrays(this,
b)};goog.net.BrowserChannel.prototype.ensureInState_=function(a){if(!goog.array.contains(arguments,this.state_))throw Error("Unexpected channel state: "+this.state_);};
goog.net.BrowserChannel.prototype.signalError_=function(a){this.channelDebug_.info("Error code "+a);if(a==goog.net.BrowserChannel.Error.REQUEST_FAILED||a==goog.net.BrowserChannel.Error.BLOCKED){var b=null;this.handler_&&(b=this.handler_.getNetworkTestImageUri(this));goog.net.tmpnetwork.testGoogleCom(goog.bind(this.testGoogleComCallback_,this),b)}else goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.ERROR_OTHER);this.onError_(a)};
goog.net.BrowserChannel.prototype.testGoogleComCallback_=function(a){a?(this.channelDebug_.info("Successfully pinged google.com"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.ERROR_OTHER)):(this.channelDebug_.info("Failed to ping google.com"),goog.net.BrowserChannel.notifyStatEvent(goog.net.BrowserChannel.Stat.ERROR_NETWORK),this.onError_(goog.net.BrowserChannel.Error.NETWORK))};
goog.net.BrowserChannel.prototype.onSuccess_=function(){this.handler_&&this.handler_.channelSuccess(this,this.pendingMaps_)};goog.net.BrowserChannel.prototype.onError_=function(a){this.channelDebug_.debug("HttpChannel: error - "+a);this.state_=goog.net.BrowserChannel.State.CLOSED;this.handler_&&this.handler_.channelError(this,a);this.onClose_();this.cancelRequests_()};
goog.net.BrowserChannel.prototype.onClose_=function(){this.state_=goog.net.BrowserChannel.State.CLOSED;this.lastStatusCode_=-1;if(this.handler_)if(0==this.pendingMaps_.length&&0==this.outgoingMaps_.length)this.handler_.channelClosed(this);else{this.channelDebug_.debug("Number of undelivered maps, pending: "+this.pendingMaps_.length+", outgoing: "+this.outgoingMaps_.length);var a=goog.array.clone(this.pendingMaps_),b=goog.array.clone(this.outgoingMaps_);this.pendingMaps_.length=0;this.outgoingMaps_.length=
0;this.handler_.channelClosed(this,a,b)}};goog.net.BrowserChannel.prototype.getForwardChannelUri=function(a){a=this.createDataUri(null,a);this.channelDebug_.debug("GetForwardChannelUri: "+a);return a};goog.net.BrowserChannel.prototype.getFirstTestResults=function(){return this.firstTestResults_};goog.net.BrowserChannel.prototype.getSecondTestResults=function(){return this.secondTestResults_};
goog.net.BrowserChannel.prototype.getBackChannelUri=function(a,b){var c=this.createDataUri(this.shouldUseSecondaryDomains()?a:null,b);this.channelDebug_.debug("GetBackChannelUri: "+c);return c};
goog.net.BrowserChannel.prototype.createDataUri=function(a,b,c){var d=goog.Uri.parse(b);if(""!=d.getDomain())a&&d.setDomain(a+"."+d.getDomain()),d.setPort(c||d.getPort());else var e=window.location,d=goog.Uri.create(e.protocol,null,a?a+"."+e.hostname:e.hostname,c||e.port,b);this.extraParams_&&goog.structs.forEach(this.extraParams_,function(a,b,c){d.setParameterValue(b,a)});d.setParameterValue("VER",this.channelVersion_);this.addAdditionalParams_(d);return d};
goog.net.BrowserChannel.prototype.createXhrIo=function(a){if(a&&!this.supportsCrossDomainXhrs_)throw Error("Can't create secondary domain capable XhrIo object.");a=new goog.net.XhrIo;a.setWithCredentials(this.supportsCrossDomainXhrs_);return a};goog.net.BrowserChannel.prototype.isActive=function(){return!!this.handler_&&this.handler_.isActive(this)};
goog.net.BrowserChannel.setTimeout=function(a,b){if(!goog.isFunction(a))throw Error("Fn must not be null and must be a function");return goog.global.setTimeout(function(){goog.net.BrowserChannel.onStartExecution();try{a()}finally{goog.net.BrowserChannel.onEndExecution()}},b)};goog.net.BrowserChannel.onStartExecution=function(){goog.net.BrowserChannel.startExecutionHook_()};goog.net.BrowserChannel.onEndExecution=function(){goog.net.BrowserChannel.endExecutionHook_()};
goog.net.BrowserChannel.getStatEventTarget=function(){return goog.net.BrowserChannel.statEventTarget_};goog.net.BrowserChannel.prototype.notifyServerReachabilityEvent=function(a){var b=goog.net.BrowserChannel.statEventTarget_;b.dispatchEvent(new goog.net.BrowserChannel.ServerReachabilityEvent(b,a))};goog.net.BrowserChannel.notifyStatEvent=function(a){var b=goog.net.BrowserChannel.statEventTarget_;b.dispatchEvent(new goog.net.BrowserChannel.StatEvent(b,a))};
goog.net.BrowserChannel.notifyTimingEvent=function(a,b,c){var d=goog.net.BrowserChannel.statEventTarget_;d.dispatchEvent(new goog.net.BrowserChannel.TimingEvent(d,a,b,c))};goog.net.BrowserChannel.prototype.shouldUseSecondaryDomains=function(){return this.supportsCrossDomainXhrs_||!goog.net.ChannelRequest.supportsXhrStreaming()};goog.net.BrowserChannel.LogSaver={};goog.net.BrowserChannel.LogSaver.buffer_=new goog.structs.CircularBuffer(1E3);goog.net.BrowserChannel.LogSaver.enabled_=!1;
goog.net.BrowserChannel.LogSaver.formatter_=new goog.debug.TextFormatter;goog.net.BrowserChannel.LogSaver.isEnabled=function(){return goog.net.BrowserChannel.LogSaver.enabled_};goog.net.BrowserChannel.LogSaver.setEnabled=function(a){if(a!=goog.net.BrowserChannel.LogSaver.enabled_){var b=goog.net.BrowserChannel.LogSaver.addLogRecord,c=goog.log.getLogger("goog.net");a?goog.log.addHandler(c,b):goog.log.removeHandler(c,b)}};goog.net.BrowserChannel.LogSaver.addLogRecord=function(a){goog.net.BrowserChannel.LogSaver.buffer_.add(goog.net.BrowserChannel.LogSaver.formatter_.formatRecord(a))};
goog.net.BrowserChannel.LogSaver.getBuffer=function(){return goog.net.BrowserChannel.LogSaver.buffer_.getValues().join("")};goog.net.BrowserChannel.LogSaver.clearBuffer=function(){goog.net.BrowserChannel.LogSaver.buffer_.clear()};goog.net.BrowserChannel.Handler=function(){};goog.net.BrowserChannel.Handler.prototype.channelHandleMultipleArrays=null;goog.net.BrowserChannel.Handler.prototype.okToMakeRequest=function(a){return goog.net.BrowserChannel.Error.OK};
goog.net.BrowserChannel.Handler.prototype.channelOpened=function(a){};goog.net.BrowserChannel.Handler.prototype.channelHandleArray=function(a,b){};goog.net.BrowserChannel.Handler.prototype.channelSuccess=function(a,b){};goog.net.BrowserChannel.Handler.prototype.channelError=function(a,b){};goog.net.BrowserChannel.Handler.prototype.channelClosed=function(a,b,c){};goog.net.BrowserChannel.Handler.prototype.getAdditionalParams=function(a){return{}};
goog.net.BrowserChannel.Handler.prototype.getNetworkTestImageUri=function(a){return null};goog.net.BrowserChannel.Handler.prototype.isActive=function(a){return!0};goog.net.BrowserChannel.Handler.prototype.badMapError=function(a,b){};goog.net.BrowserChannel.Handler.prototype.correctHostPrefix=function(a){return a};var bc={newHandler:function(a){return new goog.net.BrowserChannel.Handler}};goog.exportSymbol("bc.newHandler",bc.newHandler);
